...
```{r}
census <- read_csv("~/Grant/simulation_study/data/census.csv", show_col_types = FALSE)
cis <- read_csv("~/Grant/simulation_study/data/cis.csv", show_col_types = FALSE)
prd <- read_csv("~/Grant/simulation_study/data/prd.csv", show_col_types = FALSE)
