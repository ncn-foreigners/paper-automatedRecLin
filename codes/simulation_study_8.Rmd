...
`result_8_b` and `result_soundex_8_b` were obtained using the existing method. `result_8_cpar`, `result_8_cnonpar` and `result_8_cnonpar_hurdle` were obtained using the proposed method.
...
`result_8_b_flr_03` and `result_soundex_8_b_flr_03` were obtained using the existing method. `result_8_cpar_flr_03`, `result_8_cnonpar_flr_03` and `result_8_cnonpar_hurdle_flr_03` were obtained using the proposed method.
...
`result_8_b_flr_05` and `result_soundex_8_b_flr_05` were obtained using the existing method. `result_8_cpar_flr_05`, `result_8_cnonpar_flr_05` and `result_8_cnonpar_hurdle_flr_05` were obtained using the proposed method.
