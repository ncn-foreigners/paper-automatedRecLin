...
census <- read_csv("~/Grant/simulation_study/data/census.csv")
cis <- read_csv("~/Grant/simulation_study/data/cis.csv")
prd <- read_csv("~/Grant/simulation_study/data/prd.csv")
